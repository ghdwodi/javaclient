			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if(!(quizs.equals("5")||quizs.equals("6")||quizs.equals("7")||
						...
						int quiz_number=Integer.parseInt(quizs);
						pro1 = new Protocol();
						pro1.setCmd(800);
						pro1.setQuizMemVO(qmvo);
//						System.out.println("퀴즈 개수 : "+quiz_number*userNum);
						pro1.setIndex(quiz_number*userNum);	// 문제 수 x 유저 수
	...
	public void quizSol(int ans){		// 퀴즈 풀이 메소드
		pro1 = new Protocol();
		QuizScoreVO qsvo = new QuizScoreVO();
