...
public class Protocol implements Serializable{
	...
	public String toString() {
		return "Protocol [playVO=" + playVO + ", starVO=" + starVO + ", userVO=" + userVO + ", cmd=" + cmd
				+ ", wareBlue=" + wareBlue + ", wareBlack=" + wareBlack + ", msg=" + msg + ", serial=" + serial
				+ ", otherSerial=" + otherSerial + ", index=" + index + ", color=" + color + ", users="
